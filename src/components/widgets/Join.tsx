...
const JoinUsSection = () => {
  return (
    <section id="joinOne" className="relative w-full">
      <div className="flex items-center justify-center py-12 px-2 md:px-12 lg:px-8 dark:bg-gray-900">
        <div className="flex flex-col md:flex-row items-center max-w-4xl mx-auto">
          ...
          <div className="mb-14 md:mb-0 md:mr-14">
            <Image
              src={bannerWhite}
              alt="BDIG Banner"
              width={300} // Adjust width and height as per your needs
              height={300}
          ...
          <div className="md:text-left">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-4">Join Us</h2>
